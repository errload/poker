...
//- комбинации кроме рук героя на префлопе невозможна
...
//- топ-пара с кикером K+ на терне/ривере: обычно колл или чек-колл, если нет множественной агрессии
//- всегда проверяй, есть ли на борде карта старше пары героя
...
//- рездели действия игроков по улицам, на каждой улице начинаются новые ставки
//- если на новой улице нет ставок, call невозожен
//- оценивай силу руки героя с бордом,
//**Шоудаун {showdown}:**
...
//- называть неверные комбинации (например вторую пару называть топ парой)
//- называть несуществуюшие комбинации, всегда сравнивай руки героя с бордом
//**Формат рекомендации:**
